...
export const INITIAL_ACTIVITIES: Activity[] = [
  { id: 'pool_adult', name: 'Piscina (Adulto +10)', price: 10000, image: getStorageUrl('activities/pool-adult.jpg'), description: 'Refresque-se em nossa piscina infinita.' },
  { id: 'pool_child', name: 'Piscina (2-9 anos)', price: 7000, image: getStorageUrl('activities/pool-child.jpg'), description: 'Área segura e divertida para os pequenos.' },
  { id: 'horse', name: 'Passeio à Cavalo', price: 10000, image: getStorageUrl('activities/horse.jpg'), description: 'Passeio relaxante pela orla da praia.' },
  ...
  { id: 'lounge', name: 'Espreguiçadeira', price: 5000, image: getStorageUrl('activities/lounge.jpg'), description: 'Conforto para tomar sol.' },
  { id: 'towel', name: 'Toalha', price: 3000, description: 'Aluguel de toalha de praia.' },
  ...
  { id: 'playground', name: 'Parque Infantil', price: 0, image: getStorageUrl('activities/playground.jpg'), description: 'Diversão garantida para as crianças (Gratuito).' },
];
...
export const TRANSLATIONS: Translation = {
  ...
  about: { pt: "Sobre o Resort", en: "About the Resort" },
